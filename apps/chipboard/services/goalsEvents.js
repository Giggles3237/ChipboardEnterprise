class CompositeGoalsEventPublisher {
...
class MysqlGoalsEventOutboxPublisher {
  constructor(pool) {
    this.pool = pool;
    this.ready = null;
  }
...
module.exports = {
  CompositeGoalsEventPublisher,
  MysqlGoalsAuditLogger,
  MysqlGoalsEventOutboxPublisher
};
