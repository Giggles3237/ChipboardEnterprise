  ...
  return (
    <div className="loaner-settings-page">
      <div className="loaner-settings-header">
        ...
        <Link className="loaner-btn loaner-btn-secondary" to="/loaners">&larr; Loaner sheet</Link>
      </div>
      ...
      <p className="loaner-settings-hint">
        Discount applied once a unit reaches the breakpoint (largest breakpoint at or below miles wins).
      </p>
      <table className="loaner-settings-table loaner-settings-chart">
        <thead>
          <tr><th>Miles at least</th><th>Discount $</th><th /></tr>
        </thead>
        <tbody>
            ...
            <tr key={i}>
              ...
              <td>
                <button className="loaner-row-remove" type="button"
                  onClick={() => removeChartRow(i)}>X</button>
              </td>
            </tr>
          ))}
        </tbody>
        ...
        <tbody>
          {settings.programs.map((p, i) => (
            <tr key={i}>
              ...
              <td>
                <button className="loaner-row-remove" type="button"
                  onClick={() => removeProgram(i)}>X</button>
              </td>
            </tr>
          ))}
        </tbody>
